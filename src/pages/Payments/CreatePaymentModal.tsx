      ...
      <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 w-full max-w-md shadow-2xl">
          ...
          <div>
            ...
            <div className="space-y-2">
              <label
                ...
                style={{
                  borderColor: mode === "CASH" ? "#465fff" : "#e5e7eb",
                  backgroundColor: mode === "CASH" ? "#f0f4ff" : undefined,
                }}
                onMouseEnter={(e) =>
                  !mode === "CASH" && e.currentTarget.style.borderColor === "#465fff"
                    ? null
                    : (e.currentTarget.style.borderColor = "#d1d5db")
                }
                onMouseLeave={(e) =>
                  !mode === "CASH" && (e.currentTarget.style.borderColor = "#e5e7eb")
                }
              >
                <input
                  type="radio"
              ...
              <label
                className="flex items-center p-3 rounded-lg border-2 transition-all cursor-pointer"
                style={{
                  borderColor: mode === "ONLINE" ? "#465fff" : "#e5e7eb",
                  backgroundColor: mode === "ONLINE" ? "#f0f4ff" : undefined,
                }}
                onMouseEnter={(e) =>
                  !mode === "ONLINE" && e.currentTarget.style.borderColor === "#465fff"
                    ? null
                    : (e.currentTarget.style.borderColor = "#d1d5db")
                }
                onMouseLeave={(e) =>
                  !mode === "ONLINE" && (e.currentTarget.style.borderColor = "#e5e7eb")
                }
              >
                <input
                  type="radio"
              ...
              <div className="relative">
                ...
                >
                  <div className="text-center">
                    <svg
                      className="w-10 h-10 text-blue-500 dark:text-blue-400 mx-auto mb-2"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
        ...
        <div className="px-6 py-4 border-t border-gray-200 dark:border-gray-800 flex items-center justify-end gap-3 bg-gray-50 dark:bg-gray-800/50">
          ...
          <button
            onClick={submit}
            disabled={
              loading || !bookingNumber.trim() || !paymentDate || (mode === "ONLINE" && !file)
            }
